...
def main(host: str, port: int):
    ...
    required_key_var = 'GROQ_API_KEY' if provider == 'groq' else 'GEMINI_API_KEY'

    # Verify an API key is set for selected provider.
    if not os.getenv(required_key_var):
        raise ValueError(f'{required_key_var} environment variable not set')
